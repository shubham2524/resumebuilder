...
public class TC_Summary_031 extends Base_Class {
	...
	public void downloadResumePdf() throws InterruptedException {
		...
		Assert.assertEquals(driver.getTitle(),ExpectedTitle, "Resume not downloaded in word format");
		Reporter.log("Resume downloaded successfully in word format",true);	
		FinalPage finalPage= new FinalPage(driver);
		Thread.sleep(2000);
		actions.moveToElement(finalPage.getDownloadButton()).click().perform();
		finalPage.getWordButton().click();
		Thread.sleep(3000);	
